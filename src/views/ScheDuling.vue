      ...
      <a-row>
        ...
        <a-col :span="4">
          ...
          <div class="tablist">
            ...
            <div class="table tablisttabletest">
...
import { getScheDulingTableData } from '../assets/js/ScheDuling.js'
  ...
  data () {
    return {
      ...
      calendarOptions: {
        ...
        eventDrop: this.eventDrop, // 日程拖动事件,
        eventOverlap: false, // 是否允许日历中的时间相互重叠
        allDaySlot: false, // 周，日视图时，all-day 不显示
        resourceAreaWidth: '0', // resource资源视图的宽度为0时隐藏
        refetchResourcesOnNavigate: true,
        // groupByResource: true, // 开启resources资源分组
        resourceAreaColumns: [
          // {
          //   headerContent: '分组名称',
          //   field: 'fzmc',
  ...
  methods: {
    ...
    fetch (params = {}) {
      ...
      this.queryData({
        ...
        // console.log(getScheDulingTableData(data.rows))
        // this.data = getResPersonnelData(data.rows)
        this.tabledata = getScheDulingTableData(data.rows)
...
.tablisttabletest .ant-table table,
.tablisttabletest .ant-table table tr {
  border: 1px solid #c5dae9;
  margin-bottom: 2px;
}
.tablisttabletest .ant-table-row-cell-break-word {
  border-bottom: 1px solid #c5dae9;
}
.tablisttabletest ant-table-row:nth-child() {
  border-bottom: none;
}
.tablisttabletest .ant-table-thead {
  height: 37px !important;
}
.tablisttabletest .ant-table-thead > tr > th,
