...
function TimeColsAxisCell (props) {
  ...
  return (common.createElement(common.ViewContextType.Consumer, null, function (context) {
    ...
    var dateEnv = context.dateEnv; var options = context.options; var viewApi = context.viewApi
    ...
    return (common.createElement(common.RenderHook, { hookProps: hookProps, classNames: options.slotLabelClassNames, content: options.slotLabelContent, defaultContent: renderInnerContent, didMount: options.slotLabelDidMount, willUnmount: options.slotLabelWillUnmount }, function (rootElRef, customClassNames, innerElRef, innerContent) {
      console.log(innerContent)
      alert(innerContent)
      // 此处修改源码不起作用
      return (common.createElement("td", { ref: rootElRef, className: classNames.concat(customClassNames).join(' '), "data-time": props.isoTimeStr },
...
var TimeBodyAxis = /** @class */ (function (_super) {
  ...
  TimeBodyAxis.prototype.render = function () {
    return this.props.slatMetas.map(function (slatMeta) {
      return (common.createElement("tr", { key: slatMeta.key },
...
var TimeColsView = /** @class */ (function (_super) {
  ...
  function TimeColsView () {
    ...
    _this.renderHeadAxis = function (rowKey, frameHeight) {
      ...
      if (options.weekNumbers && rowKey === 'day') {
        return (common.createElement(common.WeekNumberRoot, { date: range.start, defaultFormat: DEFAULT_WEEK_NUM_FORMAT }, function (rootElRef, classNames, innerElRef, innerContent) {
    ...
    _this.renderTableRowAxis = function (rowHeight) {
      var _a = _this.context; var options = _a.options; var viewApi = _a.viewApi
      var hookProps = {
      ...
      return (
        ...
        common.createElement(common.RenderHook, { hookProps: hookProps, classNames: options.allDayClassNames, content: options.allDayContent, defaultContent: renderAllDayInner, didMount: options.allDayDidMount, willUnmount: options.allDayWillUnmount }, function (rootElRef, classNames, innerElRef, innerContent) {
  ...
  TimeColsView.prototype.renderSimpleLayout = function (headerRowContent, allDayContent, timeContent) {
    var _a = this; var context = _a.context; var props = _a.props
    var sections = []
    ...
    return (common.createElement(common.ViewRoot, { viewSpec: context.viewSpec, elRef: this.rootElRef }, function (rootElRef, classNames) {
      return (common.createElement("div", { className: ['fc-timegrid'].concat(classNames).join(' '), ref: rootElRef },
  ...
  TimeColsView.prototype.getAllDayMaxEventProps = function () {
    var _a = this.context.options; var dayMaxEvents = _a.dayMaxEvents; var dayMaxEventRows = _a.dayMaxEventRows
...
var TimeColsSlatsCoords = /** @class */ (function () {
  ...
  TimeColsSlatsCoords.prototype.computeTimeTop = function (duration) {
    var _a = this; var positions = _a.positions; var dateProfile = _a.dateProfile
...
var TimeColsSlatsBody = /** @class */ (function (_super) {
  ...
  TimeColsSlatsBody.prototype.render = function () {
    var _a = this; var props = _a.props; var context = _a.context
...
function buildNodes (siblingRange, buildNode) {
  ...
  var level = siblingRange.level; var lateralStart = siblingRange.lateralStart; var lateralEnd = siblingRange.lateralEnd
...
function findNextLevelSegs (hierarchy, subjectLevel, subjectLateral) {
  var levelCoords = hierarchy.levelCoords; var entriesByLevel = hierarchy.entriesByLevel
...
function stretchWeb (topLevelNodes, totalThickness) {
  var stretchNode = cacheable(function (node, startCoord, prevThickness) { return common.buildEntryKey(node) }, function (node, startCoord, prevThickness) {
    var nextLevelNodes = node.nextLevelNodes; var thickness = node.thickness
...
function computeFgSegPlacements (segs, segVCoords, // might not have for every seg
  ...
  var _a = buildPositioning(segInputs, eventOrderStrict, eventMaxStack); var segRects = _a.segRects; var hiddenGroups = _a.hiddenGroups
  var segPlacements = []
...
var TimeColMisc = /** @class */ (function (_super) {
  ...
  TimeColMisc.prototype.render = function () {
    var props = this.props
    return (common.createElement(common.DayCellContent, { date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (innerElRef, innerContent) {
      return (innerContent &&
...
var TimeCol = /** @class */ (function (_super) {
  ...
  TimeCol.prototype.render = function () {
    ...
    return (common.createElement(common.DayCellRoot, { elRef: props.elRef, date: props.date, dateProfile: props.dateProfile, todayRange: props.todayRange, extraHookProps: props.extraHookProps }, function (rootElRef, classNames, dataAttrs) {
      return (common.createElement("td", tslib.__assign({ ref: rootElRef, className: ['fc-timegrid-col'].concat(classNames, props.extraClassNames || []).join(' ') }, dataAttrs, props.extraDataAttrs),
  ...
  TimeCol.prototype.renderPositionedFgSegs = function (segs, // if not mirror, needs to be sorted
    ...
    var _this = this
    var _a = this.context.options; var eventMaxStack = _a.eventMaxStack; var eventShortHeight = _a.eventShortHeight; var eventOrderStrict = _a.eventOrderStrict; var eventMinHeight = _a.eventMinHeight
    var _b = this.props; var date = _b.date; var slatCoords = _b.slatCoords; var eventSelection = _b.eventSelection; var todayRange = _b.todayRange; var nowDate = _b.nowDate
    var isMirror = isDragging || isResizing || isDateSelecting
    var segVCoords = computeSegVCoords(segs, date, slatCoords, eventMinHeight)
    var _c = computeFgSegPlacements(segs, segVCoords, eventOrderStrict, eventMaxStack); var segPlacements = _c.segPlacements; var hiddenGroups = _c.hiddenGroups
    return (common.createElement(common.Fragment, null,
      this.renderHiddenGroups(hiddenGroups, segs),
      segPlacements.map(function (segPlacement) {
        var seg = segPlacement.seg; var rect = segPlacement.rect
        ...
        return (common.createElement("div", {
          ...
          key: instanceId,
          style: tslib.__assign(tslib.__assign({ visibility: isVisible ? '' : 'hidden' }, vStyle), hStyle)
        },
  ...
  TimeCol.prototype.renderHiddenGroups = function (hiddenGroups, segs) {
    var _a = this.props; var extraDateSpan = _a.extraDateSpan; var dateProfile = _a.dateProfile; var todayRange = _a.todayRange; var nowDate = _a.nowDate; var eventSelection = _a.eventSelection; var eventDrag = _a.eventDrag; var eventResize = _a.eventResize
  ...
  TimeCol.prototype.renderNowIndicator = function (segs) {
    var _a = this.props; var slatCoords = _a.slatCoords; var date = _a.date
    if (!slatCoords) {
      return null
    }
    return segs.map(function (seg, i) {
      return (common.createElement(common.NowIndicatorRoot, {
        ...
        key: i
      }, function (rootElRef, classNames, innerElRef, innerContent) { return (common.createElement("div", { ref: rootElRef, className: ['fc-timegrid-now-indicator-line'].concat(classNames).join(' '), style: { top: slatCoords.computeDateTop(seg.start, date) } }, innerContent)) }))
    })
  }
  TimeCol.prototype.computeSegHStyle = function (segHCoords) {
    var _a = this.context; var isRtl = _a.isRtl; var options = _a.options
...
function renderPlainFgSegs (sortedFgSegs, _a) {
  var todayRange = _a.todayRange; var nowDate = _a.nowDate; var eventSelection = _a.eventSelection; var eventDrag = _a.eventDrag; var eventResize = _a.eventResize
...
var TimeCols = /** @class */ (function (_super) {
  ...
  TimeCols.prototype.render = function () {
    var _a = this; var props = _a.props; var state = _a.state
    return (common.createElement("div", {
  ...
  TimeCols.prototype.queryHit = function (positionLeft, positionTop) {
    ...
    var _b = this.processSlotOptions(this.props.slotDuration, options.snapDuration); var snapDuration = _b.snapDuration; var snapsPerSlot = _b.snapsPerSlot
...
var DayTimeCols = /** @class */ (function (_super) {
  ...
  DayTimeCols.prototype.render = function () {
    var _this = this
    var _a = this; var props = _a.props; var context = _a.context
    var dateProfile = props.dateProfile; var dayTableModel = props.dayTableModel
    var isNowIndicator = context.options.nowIndicator
...
var DayTimeColsView = /** @class */ (function (_super) {
  ...
  DayTimeColsView.prototype.render = function () {
    var _this = this
    var _a = this.context; var options = _a.options; var dateEnv = _a.dateEnv; var dateProfileGenerator = _a.dateProfileGenerator
    var props = this.props
